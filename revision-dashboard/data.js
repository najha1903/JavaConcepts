    ...
    "topics": [
      {
        ...
        "inlineComments": [
          ...
          "static and void are another keywords in JAVA"
        ],
        ...
        "headerComments": [
          {
            ...
            "lines": [
              ...
              "In the switch statement, a variable declared in one case label code block can be accessed in another case label code block, but only if that block is after the declaration and initialisation of the variable.",
        ...
        "headerComments": [
          {
            ...
            "lines": [
              ...
              "There are lots of different types of data we can define for our variables, which are known as data types.",
              "Data types are keywords in Java.",
              "To define a variable, we need to specify the data type, then give name to the variable, and optionally assign an expression to initialise the variable with value.",
              ...
              "Java operators perform an operation on a variable or value."
            ]
          }
        ],
        "inlineComments": [
        ...
        "headerComments": [
          {
            ...
            "lines": [
              ...
              "It will first enter the do block and execute it at least once, and then check for while condition, if the while condition expression evaluates to false, it won't iterate, but if it's true, the loop will continue to execute.",
        ...
        "headerComments": [
          {
            ...
            "lines": [
              ...
              "This example defines 4 methods; trace method behavior step by step.",
              "Run through the main method flow to understand execution order and output."
            ]
          }
        ],
